...
def main():
  ...
  plistpath = scriptpath + "/resources/ParallelClipper-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ParallelClipper-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ParallelClipper-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ParallelClipper-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ParallelClipper-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/ParallelClipper.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/ParallelClipper.iss",inplace=1):
