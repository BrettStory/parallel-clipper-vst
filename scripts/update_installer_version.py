...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=ParallelClipper Demo Installer\n"
      else:
        line="OutputBaseFilename=ParallelClipper Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the ParallelClipper Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the ParallelClipper installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=ParallelClipper Demo installer\n"
     else:
       line="SetupWindowTitle=ParallelClipper installer\n"
