...
def  main():
  ...
  installer = "\installer\ParallelClipper Installer.exe"
   
  if demo:
    installer = "\installer\ParallelClipper Demo Installer.exe"
   
  FILES_TO_ZIP = [
    projectpath + installer,
    projectpath + "\installer\changelog.txt",
    projectpath + "\installer\known-issues.txt",
    projectpath + "\manual\ParallelClipper manual.pdf" 
  ]
  ...
  ZIPNAME = "ParallelClipper-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "ParallelClipper-v" + FULLVERSIONSTR + "-win-demo.zip"
