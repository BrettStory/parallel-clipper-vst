/*
  This is the initial ios app extension view controller, which is referenced by ParallelClipper-iOS-MainInterface storyboard
*/

import UIKit
import CoreAudioKit

public class ParallelClipperViewController: AUViewController {
  ...
  func connectViewWithAU() {
    // To use the generic UI (swift), change the view in ParallelClipper-iOS-MainInterface.storyboard to custom class: GenericUI  module: ParallelClipperFramework
